...
INSERT INTO tbObras (nomeObra, autorObra, dataObra, temperaturaMediaObra, umidadeMediaObra) VALUES
	('Noite Estrelada', 'Vicent Van Gogh', '1890-09-09', '10', '15'),
    ('A Persistência da Memória', 'Salvador Dali', '1785-02-25', '15', '25'),
    ('Mona Lisa', 'Leonardo da Vinci', '1548-03-03','10', '10');
